...
export default class CreateUserAndProject1603897960703
  implements MigrationInterface {
  name = 'CreateUserAndProject1603897960703';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "project" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "user_id" integer, CONSTRAINT "REL_1cf56b10b23971cfd07e4fc612" UNIQUE ("user_id"), CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
